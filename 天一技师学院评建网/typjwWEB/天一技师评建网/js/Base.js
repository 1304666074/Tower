export default {
  MyFun: function () {
    ...
    var DefualtDepartmentID = 7; //默认部门ID
    var DefualtOrganID = 5; //默认企业ID
    //数据模型
    var Model = {
      //部门
      Department: {
    ...
    var Curren = {
      ...
      formatDatebox: function (value, char) {
        ...
        date = Curren.isEmpty(char) ? value.substr(0, 10) : year + char + month + char + day;
        return date;
      },
      //判断字符是否为空的方法
    ...
    var Base = {
      ...
      GetColumnByid: function (Cid) {
        $.ajax({
          ...
          success: function (data) {
            ...
            Model.Column.LOGO = Host + Model.Nav.LOGO;
          }
        })
        return Model.Column;
      },
      ...
      GetNewsInfoByCid: function (Cid, PageIndex, PageSize, SearchWord) {
        ...
        PageSize = BasePageSize || PageSize;
